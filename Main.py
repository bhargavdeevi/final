...
main = tkinter.Tk()
main.title("Smart Traffic Detection and Control Using Canny Edge Detection Algorithm")
...
font = ('times', 16, 'bold')
title = Label(main, text='                          Smart Traffic Detection and Control Using Canny Edge Detection Algorithm',anchor=W, justify=CENTER)
